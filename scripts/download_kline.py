...
def download_data(symbol, interval, start_time, end_time, folder):
  ...
  while start_time < end_time:
    ...
    if data:
      ...
      df.to_csv(f'{folder}/{symbol}_{interval}_{start_time}_{end_time}.csv', index=False)
      print(f'Saved: {folder}/{symbol}_{interval}_{start_time}_{end_time}.csv')
    else:
      break
